defmodule LEDxServer.Config.DevicePins do
  @moduledoc """
  The Config context for DevicePins.
  """
  ...
  ## Examples
      ...
      iex> list_device_pins(device_id)
      [%DevicePin{}, ...]

  """
  def list_device_pins(device_id) do
    from(p in DevicePin, where: p.device_id == ^device_id)
    |> Repo.all()
  end
